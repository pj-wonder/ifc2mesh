"""
Test script to verify that two-line sub-junctions are correctly filtered 
when multi-line junctions exist.
"""

import sys
from pathlib import Path

# Add parent directory to path for line2point import
SCRIPT_DIR = Path(__file__).resolve().parent
LINE2POINT_DIR = SCRIPT_DIR.parent
if str(LINE2POINT_DIR) not in sys.path:
    sys.path.insert(0, str(LINE2POINT_DIR))
